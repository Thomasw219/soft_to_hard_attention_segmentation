...
class Encoder1D(nn.Module):
    def __init__(self, output_size=32, feat_size=1):
        super().__init__()
        self.linear = nn.Linear(feat_size, output_size)
...
class Decoder1D(nn.Module):
    def __init__(self, input_size, feat_size=1):
        super().__init__()
        self.l1 = nn.Linear(input_size, 256)
        self.l2 = nn.Linear(256, 256)
        self.l3 = nn.Linear(256, feat_size)
