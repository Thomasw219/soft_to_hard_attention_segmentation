...
# class FullPrototypeModelV2(nn.Module):
#     def __init__(self, cfg, data_dim, max_seq_len):
#         super().__init__()
#         self.cfg = cfg
#         self.data_dim = data_dim
...
#         self.abstract_rep_mlp_encoder = StandardMLP(input_dim=cfg.encoding_dim + cfg.positional_encoding_dim, **cfg.abstract_rep_mlp_encoder_params, output_dim=cfg.abstract_temporal_attention_dim)
#         self.abstract_rep_post = StandardMLP(input_dim=cfg.abstract_temporal_attention_dim, **cfg.abstract_rep_post_params, output_dim=cfg.abstract_rep_stoch_dim * 2)
#         self.abstract_rep_deter_mlp_encoder = StandardMLP(input_dim=cfg.abstract_rep_stoch_dim + cfg.positional_encoding_dim, **cfg.abstract_rep_deter_mlp_encoder_params, output_dim=cfg.abstract_temporal_attention_dim)
#         self.abstract_rep_deter = StandardMLP(input_dim=cfg.abstract_temporal_attention_dim, **cfg.abstract_rep_deter_params, output_dim=cfg.abstract_rep_deter_dim)
#         self.abstract_rep_prior = StandardMLP(input_dim=cfg.abstract_rep_deter_dim, **cfg.abstract_rep_prior_params, output_dim=cfg.abstract_rep_stoch_dim * 2)
#         self.abstract_rep_dim = cfg.abstract_rep_stoch_dim + cfg.abstract_rep_deter_dim

#         self.state_rep_post = StandardMLP(input_dim=cfg.encoding_dim + cfg.positional_encoding_dim + self.abstract_rep_dim, **cfg.state_rep_post_params, output_dim=cfg.state_rep_stoch_dim * 2)
#         self.state_rep_deter_mlp_encoder = StandardMLP(input_dim=cfg.state_rep_stoch_dim + cfg.positional_encoding_dim + self.abstract_rep_dim, **cfg.state_rep_deter_mlp_encoder_params, output_dim=cfg.state_temporal_attention_dim)
#         self.state_rep_deter = StandardMLP(input_dim=cfg.state_temporal_attention_dim, **cfg.state_rep_deter_params, output_dim=cfg.state_rep_deter_dim)
#         self.state_rep_prior = StandardMLP(input_dim=cfg.state_rep_deter_dim + self.abstract_rep_dim, **cfg.state_rep_prior_params, output_dim=cfg.state_rep_stoch_dim * 2)
#         self.state_rep_dim = cfg.state_rep_stoch_dim + cfg.state_rep_deter_dim
...
#         normalized_weights = attention_weights / attention_weights.sum(dim=-1, keepdim=True)
#         normalized_causal_weights = causal_attention_weights / causal_attention_weights.sum(dim=-1, keepdim=True)
#         normalized_abstract_causal_weights = abstract_causal_attention_weights / abstract_causal_attention_weights.sum(dim=-1, keepdim=True)
#         return normalized_weights, normalized_causal_weights, normalized_abstract_causal_weights
