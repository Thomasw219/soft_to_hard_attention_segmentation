...
from love.love_hssm_rl import EnvModel
...
def test_full_prototype(cfg):
    ...
    decoder = StandardMLP(input_dim=cfg['model']['belief_size'] + cfg['model']['state_size'], **cfg['decoder'], output_dim=train_dataset.action_dim)
    model = EnvModel(
        action_encoder,
        obs_encoder,
        decoder,
