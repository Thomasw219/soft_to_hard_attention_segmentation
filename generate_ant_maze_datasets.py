...
def load_policy(policy_file):
    print("Loading policy from {}".format(policy_file))
    import sys
    sys.modules['locomotion'] = d4rl.locomotion
...
def main():
    ...
    parser.add_argument('--policy_file', type=str, default='data/policies/ant_hierarch_pol.pkl', help='file_name')
